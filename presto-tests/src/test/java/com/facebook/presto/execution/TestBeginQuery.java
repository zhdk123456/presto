        ...
        extends AbstractTestQueryFramework
{
            ...
            implements Plugin
    {
        ...
        public Iterable<ConnectorFactory> getConnectorFactories(ConnectorFactoryContext context)
        {
            return ImmutableList.of(new ConnectorFactory()
            {
                ...
                {
                    return new TestConnector(metadata, connectorId);
                }
            });
        }
    }
            ...
            implements Connector
    {
        ...
        private TestConnector(ConnectorMetadata metadata, String connectorId)
        {
            this.metadata = requireNonNull(metadata, "metadata is null");
        ...
        {
            return TestingTransactionHandle.create(connectorId);
        }
