...
public class TestClientOptions
{
            ...
            throws Exception
    {
        ...
        ImmutableMap<String, String> existingProperties = ImmutableMap.of("query_max_memory", "10GB", "join_distribution_type", "partitioned");
        ...
        assertEquals(session.getProperties().get("join_distribution_type"), "partitioned");
