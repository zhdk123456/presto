        ...
        implements PartitioningSpillerFactory
{
    ...
    {
        return new GenericPartitioningSpiller(types, partitionGenerator, partitionsCount, ignorePartitions, localSpillContextSupplier, memoryContext, singleStreamSpillerFactory);
    }
}
