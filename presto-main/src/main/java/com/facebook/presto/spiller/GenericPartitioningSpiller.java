        ...
        implements PartitioningSpiller
{
            ...
            SingleStreamSpillerFactory spillerFactory)
    {
        ...
        this.localSpillContextSupplier = requireNonNull(localSpillContextSupplier, "localSpillContextSupplier; is null");
        ...
        for (int partition = 0; partition < partitionsCount; partition++) {
            ...
            spillers[partition] = spillerFactory.create(types, localSpillContextSupplier.get(), memoryContext.newLocalMemoryContext());
        }
    }
