...
import com.facebook.presto.server.SessionFactory;
        ...
        implements QueryManager
{
    ...
    @Override
    public QueryInfo createQuery(SessionFactory sessionFactory, String query)
    {
        requireNonNull(sessionFactory, "sessionFactory is null");
        ...
        Statement statement;
        try {
            session = sessionFactory.createSession(queryId, transactionManager, accessControl, sessionPropertyManager);
            ...
            if (session == null) {
                session = Session.builder(new SessionPropertyManager())
                        .setQueryId(queryId)
                        .setIdentity(sessionFactory.getIdentity())
                        .build();
            }
