...
public final class DecimalCasts
{
    ...
    public static final SqlScalarFunction DECIMAL_TO_VARCHAR_CAST = castFunctionFromDecimalTo("varchar(x)", "shortDecimalToVarchar", "longDecimalToVarchar");
    ...
    private static SqlScalarFunctionBuilder castFunctionToDecimalFromBuilder(String from, String... methodNames)
    {
        Signature signature = Signature.builder()
                ...
                .argumentTypes(parseTypeSignature(from, ImmutableSet.of("x", "precision", "scale")))
