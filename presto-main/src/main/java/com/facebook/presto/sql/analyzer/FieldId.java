...
public final class FieldId
{
    ...
    {
        requireNonNull(resolvedField, "resolvedField cannot be null");

        RelationType relationType = resolvedField.getScope().getRelationType();
        return new FieldId(relationType.getRelationId(), relationType.indexOf(resolvedField.getField()));
    }
    ...
    {
        requireNonNull(relationId, "relationId cannot be null");
