        ...
        implements PlanOptimizer
{
            ...
            extends SimplePlanRewriter<Void>
    {
        ...
        @Override
        public PlanNode visitMerge(MergeNode node, RewriteContext<Void> context)
        {
            ...
            return new MergeNode(node.getId(), node.getSourceFragmentIds(), canonicalizeAndDistinct(node.getOutputSymbols()), orderBySymbols.build(), orderings.build());
        }
