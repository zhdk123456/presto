...
public final class DomainTranslator
{
    ...
    private static Optional<NormalizedSimpleComparison> toNormalizedSimpleComparison(Metadata metadata, IdentityMap<Expression, Type> expressionTypes, Expression nonLiteral, ComparisonExpressionType comparisonType, NullableValue literal)
    {
