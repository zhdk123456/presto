...
public final class StatementRewrite
{
            ...
            boolean experimentalSyntaxEnambled)
    {
        for (Rewrite rewrite : REWRITES) {
            node = requireNonNull(rewrite.rewrite(session, metadata, parser, queryExplainer, node, parameters, accessControl, experimentalSyntaxEnambled), "Statement rewrite returned null");
        }
        return node;
    }
