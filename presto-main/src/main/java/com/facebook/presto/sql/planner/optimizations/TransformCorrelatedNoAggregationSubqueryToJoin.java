        ...
        implements PlanOptimizer
{
            ...
            extends SimplePlanRewriter<PlanNode>
    {
        ...
        private PlanNode rewriteNoAggregationSubquery(ApplyNode apply)
        {
            List<Symbol> correlation = apply.getCorrelation();
            PlanNodeDecorrelator decorrelator = new PlanNodeDecorrelator(idAllocator);
            Optional<DecorrelatedNode> source = decorrelator.decorrelateFilters(apply.getSubquery(), correlation);
            if (!source.isPresent()) {
                return apply;
            }
