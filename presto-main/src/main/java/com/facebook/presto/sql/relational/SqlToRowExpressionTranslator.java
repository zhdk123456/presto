...
public final class SqlToRowExpressionTranslator
{
    ...
    public static RowExpression translate(
            ...
            IdentityMap<Expression, Type> types,
            ...
            extends AstVisitor<RowExpression, Void>
    {
        ...
        private final IdentityMap<Expression, Type> types;
        private final TypeManager typeManager;
        private final TimeZoneKey timeZoneKey;

        private Visitor(FunctionKind functionKind, IdentityMap<Expression, Type> types, TypeManager typeManager, TimeZoneKey timeZoneKey)
        {
