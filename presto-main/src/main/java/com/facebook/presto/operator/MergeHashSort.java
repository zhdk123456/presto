        ...
        implements Closeable
{
    ...
    {
        List<Iterator<PagePosition>> channelIterators = channels.stream().map(channel -> {
            return new SingleChannelPagePositions(channel, memoryContext.newLocalMemoryContext());
        }).collect(toList());
