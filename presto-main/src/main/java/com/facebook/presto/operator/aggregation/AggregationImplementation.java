...
public class AggregationImplementation implements ParametricImplementation
{
    ...
    public AggregationImplementation(Signature signature,
            ...
            List<ParameterType> parameterMetadataTypes)
    {
        ...
        this.parameterMetadataTypes = requireNonNull(parameterMetadataTypes, "parameterMetadataTypes cannot be null");
    }
    ...
    public List<ParameterType> getParameterMetadataTypes()
    {
        return parameterMetadataTypes;
    }
        ...
        private static List<ParameterType> parseParameterMetadataTypes(Method method)
        {
            ...
            for (; i < annotations.length; ++i) {
                ...
                if (isImplementationDependencyAnnotation(baseTypeAnnotation)) {
                    ...
                    // For that reason there are ommited in parameter metadata, as they
