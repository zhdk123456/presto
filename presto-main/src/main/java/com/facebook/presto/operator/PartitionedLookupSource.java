        ...
        implements LookupSource
{
     ...
     *
     * Synchronization in commit() is required because each writing thread must have
     * memory barrier, so that it writes its state of visitedPositions to main memory
     * before visitedPositions is read in getVisitedPositions().
     */
    private static class OuterPositionTracker
    {
        public static class Factory
        {
            ...
            public synchronized OuterPositionTracker create()
            {
        ...
        /**
         * Synchronization only for ensuring that there is a memory barrier before after writting.
         * Check comment above.
         */
        ...
        public synchronized boolean[][] getVisitedPositions()
        {
