...
public class BenchmarkMultiJoin2
{
    ...
    public static class BuildContext
    {
        ...
        protected static final int BUILD_ROWS_NUMBER = 800_000;
    ...
    {
        protected static final int PROBE_ROWS_NUMBER = 800_000;
        ...
        protected List<Page> initializeProbePages()
        {
            ...
            /*List<Page> pages = probePagesBuilder.build();
            List<Page> resultPages = new ArrayList<>();
            for (int i = 0; i < pages.size(); ++i) {
                resultPages.add(pages.get(0));
                //resultPages.add(pages.get(0).getRegion(0, pages.get(0).getPositionCount()));
            }
            return resultPages;*/
        }
    ...
    public void test8()
    {
        ...
        joinContext.setup();
        List<List<Page>> buildPages = ImmutableList.of(joinContext.buildPages1, joinContext.buildPages2, joinContext.buildPages3, joinContext.buildPages4, joinContext.buildPages5, joinContext.buildPages6, joinContext.buildPages7, joinContext.buildPages8);
    ...
    {
        baselineMultiJoin(joinContext, ImmutableList.of(joinContext.buildPages1, joinContext.buildPages2, joinContext.buildPages3, joinContext.buildPages4, joinContext.buildPages5, joinContext.buildPages6, joinContext.buildPages7, joinContext.buildPages8));
    }

    //@Benchmark
    public void baseline4(JoinContext joinContext)
    {
        baselineMultiJoin(joinContext, ImmutableList.of(joinContext.buildPages1, joinContext.buildPages2, joinContext.buildPages3, joinContext.buildPages4));
    }

    //@Benchmark
    public void baseline3(JoinContext joinContext)
    {
        baselineMultiJoin(joinContext, ImmutableList.of(joinContext.buildPages1, joinContext.buildPages2, joinContext.buildPages3));
    }

    //@Benchmark
    public void baseline2(JoinContext joinContext)
    {
        baselineMultiJoin(joinContext, ImmutableList.of(joinContext.buildPages1, joinContext.buildPages2));
    }

    //@Benchmark
    public void xcompile8(JoinContext joinContext)
    {
        xcompiledMultiJoin(joinContext, ImmutableList.of(joinContext.buildPages1, joinContext.buildPages2, joinContext.buildPages3, joinContext.buildPages4, joinContext.buildPages5, joinContext.buildPages6, joinContext.buildPages7, joinContext.buildPages8));
    }

    //@Benchmark
    public void xcompile4(JoinContext joinContext)
    {
        xcompiledMultiJoin(joinContext, ImmutableList.of(joinContext.buildPages1, joinContext.buildPages2, joinContext.buildPages3, joinContext.buildPages4));
    }

    //@Benchmark
    public void xcompile3(JoinContext joinContext)
    {
        xcompiledMultiJoin(joinContext, ImmutableList.of(joinContext.buildPages1, joinContext.buildPages2, joinContext.buildPages3));
    }

    //@Benchmark
    public void xcompile2(JoinContext joinContext)
    {
        xcompiledMultiJoin(joinContext, ImmutableList.of(joinContext.buildPages1, joinContext.buildPages2));
    }
            ...
            throws RunnerException
    {
        Options options = new OptionsBuilder()
                ...
                .include(".*" + BenchmarkMultiJoin2.class.getSimpleName() + ".*")
                .build();
