...
public final class FunctionAssertions
{
    ...
    private OperatorFactory compileFilterWithNoInputColumns(Expression filter, ExpressionCompiler compiler)
    {
        ...
        IdentityMap<Expression, Type> expressionTypes = getExpressionTypesFromInput(TEST_SESSION, metadata, SQL_PARSER, INPUT_TYPES, ImmutableList.of(filter), emptyList());
    ...
    private OperatorFactory compileFilterProject(Expression filter, Expression projection, ExpressionCompiler compiler)
    {
        ...
        IdentityMap<Expression, Type> expressionTypes = getExpressionTypesFromInput(TEST_SESSION, metadata,
    ...
    private RowExpression toRowExpression(Expression projection, IdentityMap<Expression, Type> expressionTypes)
    {
