        ...
        extends AbstractTestFunctions
{
            ...
            throws Exception
    {
        ...
        assertFunction("transform(ARRAY [25, 26], x -> x + DOUBLE '1.0')", new ArrayType(DOUBLE), ImmutableList.of(26.0, 27.0));
        ...
        assertFunction("transform(ARRAY [25.6, 27.3], x -> x + DOUBLE '1.0')", new ArrayType(DOUBLE), ImmutableList.of(26.6, 28.3));
        ...
        assertFunction(
                "transform(ARRAY [25.6, DOUBLE '27.3'], x -> MAP(ARRAY[x + 1], ARRAY[true]))",
        ...
        assertFunction("transform(ARRAY [false, true], x -> if(x, DOUBLE '25.6', DOUBLE '28.9'))", new ArrayType(DOUBLE), ImmutableList.of(28.9, 25.6));
