...
public class BenchmarkBinaryFileSpiller
{
    ...
    public static class BenchmarkData
    {
                ...
                throws ExecutionException, InterruptedException
        {
            ...
            readSpiller = spillerFactory.create(TYPES,  () -> new LocalSpillContext(new TestOperatorSpillContext()), new AggregatedMemoryContext());
        ...
        {
            return spillerFactory.create(TYPES, () -> new LocalSpillContext(new TestOperatorSpillContext()), new AggregatedMemoryContext());
        }
    }
}
