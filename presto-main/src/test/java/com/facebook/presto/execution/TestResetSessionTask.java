...
public class TestResetSessionTask
{
            ...
            throws Exception
    {
        ...
        QueryStateMachine stateMachine = QueryStateMachine.begin(new QueryId("query"), "reset foo", session, URI.create("fake://uri"), false, transactionManager, executor, metadata);
