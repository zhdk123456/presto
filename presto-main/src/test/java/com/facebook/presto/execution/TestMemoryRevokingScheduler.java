...
public class TestMemoryRevokingScheduler
{
            ...
            throws Exception
    {
        ...
        TaskContext taskContext1 = sqlTask1.getQueryContext().addTaskContext(new TaskStateMachine(new TaskId("q1", 1, 1), executor), session, new DataSize(0, BYTE), false, false);
        ...
        TaskContext taskContext2 = sqlTask2.getQueryContext().addTaskContext(new TaskStateMachine(new TaskId("q2", 1, 1), executor), session, new DataSize(0, BYTE), false, false);
