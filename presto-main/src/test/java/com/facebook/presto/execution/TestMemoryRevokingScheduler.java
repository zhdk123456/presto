...
public class TestMemoryRevokingScheduler
{
    ...
    private SqlTask newSqlTask()
    {
        ...
        SpillSpaceTracker spillSpaceTracker = new SpillSpaceTracker(new DataSize(1, MEGABYTE));
        return new SqlTask(
                taskId,
                location,
                new QueryContext(new QueryId("query"), new DataSize(1, MEGABYTE), new MemoryPool(new MemoryPoolId("test"), new DataSize(1, GIGABYTE)), systemMemoryPool, executor,  new DataSize(1, MEGABYTE), spillSpaceTracker),
