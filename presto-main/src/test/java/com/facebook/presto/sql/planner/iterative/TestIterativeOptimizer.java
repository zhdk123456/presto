...
public class TestIterativeOptimizer
{
    ...
    {
        PlanOptimizer optimizer = new IterativeOptimizer(new StatsRecorder(), ImmutableSet.of(new NonConvergingRule()), 1);
            ...
            implements Rule
    {
        ...
        // In that case, it will remove it.
        // Thanks to that it never converges.
        @Override
