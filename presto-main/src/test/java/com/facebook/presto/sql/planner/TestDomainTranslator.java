...
public class TestDomainTranslator
{
    ...
    private static final Symbol C_CHAR_10 = new Symbol("c_char_10");
    ...
    private static final Map<Symbol, Type> TYPES = ImmutableMap.<Symbol, Type>builder()
            ...
            .put(C_CHAR_10, createCharType(10))
            .build();
...
//        assertTrue(result.getTupleDomain().isNone());
    ...
    {
        // greater than or equal
        testSimpleComparison(greaterThanOrEqual(C_CHAR_10, stringLiteral("123456789")), C_CHAR_10, Range.greaterThan(createCharType(10), Slices.utf8Slice("12345678")));
        testSimpleComparison(greaterThanOrEqual(C_CHAR_10, stringLiteral("1234567890")), C_CHAR_10, Range.greaterThanOrEqual(createCharType(10), Slices.utf8Slice("1234567890")));
        testSimpleComparison(greaterThanOrEqual(C_CHAR_10, stringLiteral("12345678901")), C_CHAR_10, Range.greaterThan(createCharType(10), Slices.utf8Slice("1234567890")));

        // greater than
        testSimpleComparison(greaterThan(C_CHAR_10, stringLiteral("123456789")), C_CHAR_10, Range.greaterThan(createCharType(10), Slices.utf8Slice("12345678")));
        testSimpleComparison(greaterThan(C_CHAR_10, stringLiteral("1234567890")), C_CHAR_10, Range.greaterThan(createCharType(10), Slices.utf8Slice("1234567890")));
        testSimpleComparison(greaterThan(C_CHAR_10, stringLiteral("12345678901")), C_CHAR_10, Range.greaterThan(createCharType(10), Slices.utf8Slice("1234567890")));

        // less than or equal
        testSimpleComparison(lessThanOrEqual(C_CHAR_10, stringLiteral("123456789")), C_CHAR_10, Range.lessThanOrEqual(createCharType(10), Slices.utf8Slice("12345678")));
        testSimpleComparison(lessThanOrEqual(C_CHAR_10, stringLiteral("1234567890")), C_CHAR_10, Range.lessThanOrEqual(createCharType(10), Slices.utf8Slice("1234567890")));
        testSimpleComparison(lessThanOrEqual(C_CHAR_10, stringLiteral("12345678901")), C_CHAR_10, Range.lessThanOrEqual(createCharType(10), Slices.utf8Slice("1234567890")));

        // less than
        testSimpleComparison(lessThan(C_CHAR_10, stringLiteral("123456789")), C_CHAR_10, Range.lessThanOrEqual(createCharType(10), Slices.utf8Slice("12345678")));
        testSimpleComparison(lessThan(C_CHAR_10, stringLiteral("1234567890")), C_CHAR_10, Range.lessThan(createCharType(10), Slices.utf8Slice("1234567890")));
        testSimpleComparison(lessThan(C_CHAR_10, stringLiteral("12345678901")), C_CHAR_10, Range.lessThanOrEqual(createCharType(10), Slices.utf8Slice("1234567890")));

        // equal
        testSimpleComparison(equal(C_CHAR_10, stringLiteral("123456789")), C_CHAR_10, Domain.none(createCharType(10)));
        testSimpleComparison(equal(C_CHAR_10, stringLiteral("1234567890")), C_CHAR_10, Range.equal(createCharType(10), Slices.utf8Slice("1234567890")));
        testSimpleComparison(equal(C_CHAR_10, stringLiteral("12345678901")), C_CHAR_10, Domain.none(createCharType(10)));

        // not equal
        testSimpleComparison(notEqual(C_CHAR_10, stringLiteral("123456789")), C_CHAR_10, Domain.notNull(createCharType(10)));
        testSimpleComparison(notEqual(C_CHAR_10, stringLiteral("1234567890")), C_CHAR_10, Domain.create(ValueSet.ofRanges(
        ...
        testSimpleComparison(notEqual(C_CHAR_10, stringLiteral("12345678901")), C_CHAR_10, Domain.notNull(createCharType(10)));

        // is distinct from
        testSimpleComparison(isDistinctFrom(C_CHAR_10, stringLiteral("123456789")), C_CHAR_10, Domain.all(createCharType(10)));
        testSimpleComparison(isDistinctFrom(C_CHAR_10, stringLiteral("1234567890")), C_CHAR_10, Domain.create(ValueSet.ofRanges(
        ...
        testSimpleComparison(isDistinctFrom(C_CHAR_10, stringLiteral("12345678901")), C_CHAR_10, Domain.all(createCharType(10)));
    }
