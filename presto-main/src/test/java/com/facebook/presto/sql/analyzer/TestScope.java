...
public class TestScope
{
    ...
    public void test()
    {
        ...
        Scope outer = Scope.builder().withParent(root).withRelationType(new RelationType(RelationId.anonymous(), outerColumn1, outerColumn2)).build();
        ...
        Scope inner = Scope.builder()
                .withOuterQueryParent(outer)
                .withRelationType(new RelationType(RelationId.anonymous(), innerColumn2, innerColumn3))
                .build();
