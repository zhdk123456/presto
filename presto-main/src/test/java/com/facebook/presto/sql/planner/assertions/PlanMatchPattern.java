...
public final class PlanMatchPattern
{
    ...
    public static PlanMatchPattern window(ExpectedWindowNodeSpecification specification, List<ExpectedFunctionCall> functionCalls, PlanMatchPattern source)
    {
    ...
    public static ExpectedFunctionCall functionCall(String name, Optional<WindowFrame> frame, String... symbolAliases)
    {
        return new ExpectedFunctionCall(QualifiedName.of(name), Arrays.asList(symbolAliases), frame);
    }
