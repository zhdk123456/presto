...
public class GenericPartitioningSpillerTest
{
    ...
    private final SingleStreamSpillerFactory singleStreamSpillerFactory = new BinaryFileSingleStreamSpillerFactory(blockEncodingSerde, new SpillerStats(), new FeaturesConfig());
            ...
            throws Exception
    {
        ...
        try (PartitioningSpiller spiller = factory.create(
                ...
                PARTITIONS_COUNT,
                ImmutableSet.of(0, 3),
                () -> new LocalSpillContext(new TestOperatorSpillContext()), memoryContext)) {
