        ...
        implements ConnectorNodePartitioningProvider
{
    ...
    {
        long totalRows = checkType(partitioningHandle, TpcdsPartitioningHandle.class, "functionHandle").getTotalRows();
        ...
        return new TpcdsBucketFunction(bucketCount, rowsPerBucket);
    }
}
