-- database: presto; groups: tpcds,quarantine,big_query
--- does not end
WITH cs_ui AS
  (SELECT cs_item_sk,
...
cross_sales AS
  (SELECT i_product_name product_name,
   ...
   FROM "tpcds"."sf1".store_sales,
        ...
        "tpcds"."sf1".promotion,
        "tpcds"."sf1".household_demographics hd1,
        "tpcds"."sf1".household_demographics hd2,
        "tpcds"."sf1".customer_address ad1,
        "tpcds"."sf1".customer_address ad2,
        "tpcds"."sf1".income_band ib1,
        "tpcds"."sf1".income_band ib2,
        "tpcds"."sf1".item
