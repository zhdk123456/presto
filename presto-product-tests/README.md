...
Please keep in mind that if you run tests on Hive <1.1.0, you should exclude test from `hive_1_1_0` group by passing the following flag to tempto: `-x hive_1_1_0`.
