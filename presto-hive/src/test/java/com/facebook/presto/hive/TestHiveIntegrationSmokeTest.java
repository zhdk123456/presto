        ...
        extends AbstractTestIntegrationSmokeTest
{
            ...
            throws Exception
    {
        ...
        assertUpdate("INSERT INTO test_insert_format_table (_tinyint, _smallint, _integer, _bigint, _double) SELECT CAST(1 AS TINYINT), CAST(2 AS SMALLINT), 3, 4, DOUBLE '14.3'", 1);
