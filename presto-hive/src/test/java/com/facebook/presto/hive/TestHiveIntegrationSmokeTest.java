        ...
        extends AbstractTestIntegrationSmokeTest
{
            ...
            throws Exception
    {
        ...
        assertQueryFails("CREATE ROLE role1 WITH ADMIN admin", ".*?Hive Connector does not support WITH ADMIN statement");
            ...
            throws Exception
    {
        ...
        assertQueryFails("CREATE ROLE duplicate_role", ".*?Role 'duplicate_role' already exists");
            ...
            throws Exception
    {
        ...
        Session unsetRole = Session.builder(queryRunner.getDefaultSession())
                .setIdentity(new Identity("set_user_1", Optional.empty()))
                .build();
        Session setRoleAll = Session.builder(queryRunner.getDefaultSession())
                .setIdentity(new Identity("set_user_1", Optional.empty()))
                .setRole("hive", new SelectedRole(SelectedRole.Type.ALL, Optional.empty()))
                .build();
        Session setRoleNone = Session.builder(queryRunner.getDefaultSession())
                .setIdentity(new Identity("set_user_1", Optional.empty()))
                .setRole("hive", new SelectedRole(SelectedRole.Type.NONE, Optional.empty()))
                .build();
        Session setRole1 = Session.builder(queryRunner.getDefaultSession())
                .setIdentity(new Identity("set_user_1", Optional.empty()))
                .setRole("hive", new SelectedRole(SelectedRole.Type.ROLE, Optional.of("set_role_1")))
                .build();
        Session setRole2 = Session.builder(queryRunner.getDefaultSession())
                .setIdentity(new Identity("set_user_1", Optional.empty()))
                .setRole("hive", new SelectedRole(SelectedRole.Type.ROLE, Optional.of("set_role_2")))
                .build();
        Session setRole3 = Session.builder(queryRunner.getDefaultSession())
                .setIdentity(new Identity("set_user_1", Optional.empty()))
                .setRole("hive", new SelectedRole(SelectedRole.Type.ROLE, Optional.of("set_role_3")))
                .build();
        Session setRole4 = Session.builder(queryRunner.getDefaultSession())
                .setIdentity(new Identity("set_user_1", Optional.empty()))
                .setRole("hive", new SelectedRole(SelectedRole.Type.ROLE, Optional.of("set_role_4")))
                .build();

        MaterializedResult actual = queryRunner.execute(unsetRole, "SELECT * FROM hive.information_schema.applicable_roles");
        ...
        actual = queryRunner.execute(unsetRole, "SELECT * FROM hive.information_schema.enabled_roles");
        ...
        actual = queryRunner.execute(setRoleAll, "SELECT * FROM hive.information_schema.enabled_roles");
        ...
        actual = queryRunner.execute(setRoleNone, "SELECT * FROM hive.information_schema.enabled_roles");
        expected = MaterializedResult.resultBuilder(setRoleNone, createUnboundedVarcharType())
                .row("public")
                .build();
        assertEqualsIgnoreOrder(actual, expected);

        actual = queryRunner.execute(setRole1, "SELECT * FROM hive.information_schema.enabled_roles");
        ...
        actual = queryRunner.execute(setRole2, "SELECT * FROM hive.information_schema.enabled_roles");
        ...
        actual = queryRunner.execute(setRole3, "SELECT * FROM hive.information_schema.enabled_roles");
