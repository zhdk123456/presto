        ...
        extends AbstractTestIntegrationSmokeTest
{
            ...
            throws Exception
    {
        ...
        assertUpdate(session, "INSERT INTO test_insert_format_table (_tinyint, _smallint, _integer, _bigint, _real, _double) SELECT CAST(1 AS TINYINT), CAST(2 AS SMALLINT), 3, 4, cast(14.3 as REAL), DOUBLE '14.3'", 1);
        ...
        assertUpdate(session, "INSERT INTO test_insert_format_table (_double, _bigint) SELECT DOUBLE '2.72', 3", 1);
            ...
            throws Exception
    {
        ...
        assertUpdate("CREATE TABLE tmp_map12 AS SELECT MAP(ARRAY[DOUBLE '1.0'], ARRAY[ARRAY[1, 2]]) AS col", 1);
