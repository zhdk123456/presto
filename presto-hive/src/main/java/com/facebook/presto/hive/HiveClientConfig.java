...
public class HiveClientConfig
{
    ...
    @Config("hive.mapr.cluster-name")
    public HiveClientConfig setMaprClusterName(String maprClusterName)
    {
        this.maprClusterName = maprClusterName;
        return this;
    }

    public String getMaprClusterName()
    {
