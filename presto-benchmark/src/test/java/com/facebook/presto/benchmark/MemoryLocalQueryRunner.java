...
public class MemoryLocalQueryRunner
{
    ...
    public void execute(@Language("SQL") String query)
    {
        ...
        SpillSpaceTracker spillTracker = new SpillSpaceTracker(new DataSize(1, TERABYTE));
        TaskContext taskContext = new QueryContext(new QueryId("test"), new DataSize(256, MEGABYTE), memoryPool, systemMemoryPool, executor, new DataSize(1, TERABYTE), spillTracker)
