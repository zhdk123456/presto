...
public class MemoryLocalQueryRunner
{
    ...
    public void execute(@Language("SQL") String query)
    {
        ...
        SpillSpaceTracker spillSpaceTracker = new SpillSpaceTracker(new DataSize(1, PETABYTE));
        TaskContext taskContext = new QueryContext(new QueryId("test"), new DataSize(256, MEGABYTE), memoryPool, systemMemoryPool, executor, new DataSize(1, PETABYTE), spillSpaceTracker)
